    ...
    <div className="ptc__header section__padding" id="home">
      <div className="ptc__header-content">
        ...
        <div className="ptc__header-content_button">
          <button className="ptc__header-button_out" type="button">
            Start Predicting
          </button>
          <button className="ptc__header-button_pred" type="button">
            Earn PRED
          </button>
          <button className="ptc__header-button_bnb" type="button">
            Earn BNB
          </button>
        </div>
      </div>
